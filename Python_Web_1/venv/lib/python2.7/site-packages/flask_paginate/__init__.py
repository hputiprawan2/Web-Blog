...
DISPLAY_MSG = '''Total records <b>{start} - {end}</b> {record_name} in
total <b>{total}</b>'''

SEARCH_MSG = '''found <b>{found}</b> {record_name},
displaying <b>{start} - {end}</b>'''

CSS_LINKS = dict(bootstrap='<div class="pagination{0}{1}">',
                 bootstrap2='<div class="pagination{0}{1}">',
                 bootstrap3='<class="pagination{0}{1}">',
                 foundation='<class="pagination{0}{1}">',
                 )
CSS_LINKS_END = dict(bootstrap='</div>',
                     bootstrap2='</div>',
                     bootstrap3='',
                     foundation='',
                     )
